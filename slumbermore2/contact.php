...
#EDIT THE FOLLOWING:
$toAddress = "pdodd001@seattlecentral.edu";  //place your/your client's email address here - EDISON/ZEPHIR WILL ONLY EMAIL seattlecentral.edu ADDRESSES!
$toName = "Slumbermore"; //place your client's name here
$website = "Slumbermore.com";  //place NAME of your client's website here
	...
	<table class="contact-table">
		<tr><!-- the form elements 'Name' and 'Email' are sigificant to the app, any others can be added/deleted -->
			<td>
				...
				<input type="text" name="Name" required placeholder="Name" title="Name is required" />
			</td>
		</tr>
		<tr>
			<td>
				<span class="required"></span>Email:<br />
				<input type="email" name="Email" required placeholder="Email" title="A valid email is required" />
			</td>
		</tr>
		<tr>
			<td>
